package com.ghn.android.news.util;
...
public class Constant implements Serializable {
	...
	public  static final String SERVER_URL = "http://freshersbee.com/rojgar_app_portal/news_app";
	...
	public static final String SERVER_IMAGE_NEWSLIST_THUMBS="http://freshersbee.com/rojgar_app_portal/upload/thumbs/";
 	//this is the path of uploaded image of news list
	public static final String SERVER_IMAGE_NEWSLISTDETAILS="http://freshersbee.com/rojgar_app_portal/upload/";
	...
	public static final String LATEST_URL = "http://freshersbee.com/rojgar_app_portal/api.php?latest_news=500";
	//this url gives list of category in 2nd tab
	public static final String CATEGORY_URL = "http://freshersbee.com/rojgar_app_portal/api.php";
	//this url gives item of specific category.
	public static final String CATEGORY_ITEM_URL = "http://freshersbee.com/rojgar_app_portal/api.php?cat_id=";
	//this url gives your company details
	public static final String COMPANY_DETAILS_URL = "http://freshersbee.com/rojgar_app_portal/api.php?apps_details";
